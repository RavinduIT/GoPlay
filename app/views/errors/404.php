...
<div class="min-h-screen bg-gray-100 flex items-center justify-center">
    <div class="max-w-md mx-auto text-center">
        ...
        <div class="space-y-4">
            ...
            <button onclick="history.back()" class="block w-full bg-gray-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-gray-700 transition-colors">
                Go Back
            </button>
        </div>
        
        <div class="mt-8 text-sm text-gray-500">
            <p>Need help? <a href="<?= $_base ?>/contact" class="text-blue-600 hover:text-blue-800">Contact Support</a></p>
        </div>
    </div>
</div>