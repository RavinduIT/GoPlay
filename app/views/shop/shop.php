  ...
  <script src="/frontend/js/pages/shop.js"></script>
    <script>
        ...
        function proceedToCheckout() {
            ...
            window.location.href = `/frontend/pages/payment.html?${params.toString()}`;
        }
    </script>
    <style>/* Professional Shop CSS - Modern E-commerce Design */
