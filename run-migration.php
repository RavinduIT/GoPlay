<?php
/**
 * Run Migration: Add shop_owner_id to products table
 * 
 * This script runs the migration safely through PHP
 */
...
try {
    ...
    if ($stats['with_owner'] == 0 && $stats['total'] > 0) {
        ...
        echo "  Run 'php fix-shop-owner-orders.php' to assign products to shop owners.\n\n";
    ...
    echo "Next Steps:\n";
    echo "1. If you have unassigned products, run: php fix-shop-owner-orders.php\n";
