...
-- Description: Stores applications from users who want to become providers (ground owner, coach, shop owner)
...
-- Create a view for pending applications count by type
